# Midterm Traceability Matrix

| Midterm Requirement | Artifact | Evidence |
| --- | --- | --- |
...
| Task 2.1 automation expansion | docs/midterm-automation-expansion.md; metrics/midterm-new-tests.csv | tests/* new files + midterm new logs |
...
| Task 3 metrics collection | docs/midterm-metrics-report.md; metrics/midterm-required-metrics.csv | phase2 metrics + midterm execution logs |
...
| Task 5 final report package | docs/midterm-final-report.md; reports/midterm-report-summary.md | All midterm docs/metrics/charts/evidence |
