...
This folder contains Assignment 2 (Phase 2) artifacts for the KazUTB Digital Library.

## Scope delivered

- High-risk automation scope definition grounded in Phase 1 risk analysis.
...
3. Run targeted PHPUnit subset used by Phase 2 evidence.
